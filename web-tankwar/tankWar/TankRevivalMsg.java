...
public class TankRevivalMsg implements Message{
	int MSG_TYPE =Message.TANK_REVIVAL_MSG;
	int ID;
	boolean islive;
	TankClient tc;
	Tank t ;
	
	public TankRevivalMsg(int iD, boolean islive) {
		ID = iD;
		this.islive = islive;
	}
	
	public TankRevivalMsg(Tank t) {
		this.t = t;
	}
	
	public TankRevivalMsg(TankClient tc)
	{
		this.tc = tc;
	}
